...
class ReflectionHelper
{
     ...
     *
     * May be called recursively if the type is a union of types. In this
     * case, the first type in the union is returned.
     *
     ...
     */
    private static function getNameForType(?\ReflectionType $reflectionType): ?string
    {
        $propType = null;
